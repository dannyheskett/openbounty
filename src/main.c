...
// player dismisses their last army: teleport home, wipe army, remove siege
// weapons, grant 20 peasants, dismount. The dialog is opened here so every
// entry point surfaces the same "King dismisses you" message.
// ===========================================================================

static void perform_temp_death(Game *g, Map *map, Fog *fog,
                               const Resources *res) {
...
// ===========================================================================
// End-of-week two-screen sequence .
// Call schedule_week_end() whenever a week boundary is crossed. The main
// loop pops each pending screen before it processes input.
// ===========================================================================
...
// Try to advance the week-end dialog sequence. Returns true if a dialog
// was opened (caller should pause normal input).
static bool pump_week_end_dialog(const Game *g) {
...
// ===========================================================================
// Movement + interaction shared by both modes.
// ===========================================================================
...
//   2. KB_BottomBox(message, "", MSG_PAUSE)   ← message has the king's words
// We open the fanfare dialog now and stash the king's message for the
// generic dialog-dismiss path to chain into a second open_dialog.
...
//  Recruit branch. Picks one of
// the five castle-dwelling troops (peasants/militia/archers/pikemen/
// knights) and opens the standard recruit prompt. Unlike dwellings,
// the home castle has no population cap — only gold + leadership
// bound the purchase. Troop rotates with (seed, days_left) so each
