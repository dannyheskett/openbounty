...
// can hold; the gold cap governs what you can afford. A reserve
// (RECRUIT_GOLD_RESERVE, below) is held back so the player isn't left
// cashless after a max-out recruit.
