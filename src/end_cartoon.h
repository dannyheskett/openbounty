...
// Run victory cutscene (OpenKB's game.c:4281 draw_cartoon_frame /
// its game.c:4374 display_cartoon). Draws a grass grid with a carpet/bridge
...
// letterboxed 2x (or higher) scale as the adventure view.
//
