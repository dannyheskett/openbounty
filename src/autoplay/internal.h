...
typedef enum {
    ...
    // Mid-tour Continentia re-recruit. After leg 29 (chest_039 at
    // (11,26)) the hero's HP is too thin to push through the wandering-
    // army gauntlet that guards the north chests + artifacts +
    // navmap. Sail back to king_maximus, max-buy fresh stacks, sail
    // back to Forestria, resume the tour at leg 30.
    AP_FLOW_PHASE12_MID_RETURN_SPAWN,
    AP_FLOW_PHASE12_MID_OPEN_NAV_HOME,
    AP_FLOW_PHASE12_MID_PICK_CONTINENTIA,
    AP_FLOW_PHASE12_MID_NAV_HOME,
    AP_FLOW_PHASE12_MID_OPEN_RECRUIT,
    AP_FLOW_PHASE12_MID_RECRUIT_KNIGHTS,
    AP_FLOW_PHASE12_MID_RECRUIT_CAVALRY,
    AP_FLOW_PHASE12_MID_RECRUIT_ARCHERS,
    AP_FLOW_PHASE12_MID_RECRUIT_PIKEMEN,
    AP_FLOW_PHASE12_MID_RECRUIT_MILITIA,
    AP_FLOW_PHASE12_MID_EXIT_RECRUIT,
    AP_FLOW_PHASE12_MID_EXIT_CASTLE,
    AP_FLOW_PHASE12_MID_NAV_SEA,
    AP_FLOW_PHASE12_MID_OPEN_NAV_FOREST,
