...
// (one branch). The call sites scattered through engine + shell stay
// always-on; the recorder decides whether to do work.
...
// encoder (mp4_encode_dir) before calling this. Safe to call when never
// initialized.
