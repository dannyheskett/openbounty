...
#include "views.h"
#include "player_io.h"   // M4: engine views arrive via the player-IO queue
#include "raylib.h"
#include "audio.h"
#include "tables.h"
#include "recorder.h"
...
void views_open_town(const char *display_name, const char *record_key,
    ...
    // M4: set the town context statics only. The VIEW_TOWN presentation is now
...
static void town_do_boat(Game *g) {
    ...
    // headless autoplay can rent too; this keeps only the dialogs. Behavior is
