...
// Read <dir>/manifest.ndjson + tick_*.png, encode H.264 baseline
// (visually lossless), mux into MP4. Synchronous. Calls `cb` after
// each frame is encoded so the caller can render a progress dialog.
