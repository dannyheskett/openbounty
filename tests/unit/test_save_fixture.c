...
//
// To regenerate after an intentional format change: resurrect
// tools/mint_save_fixture.c from git history (deleted pre-build #1)
// or write a one-shot in any sibling tool.
