// OpenBounty test runner. Layered into four categories by suite-name
...
//   tests/autoplay/    -- the oracle's determinism plumbing
//
...
SUITE_EXTERN(unit_touch_regions_suite);
...
SUITE_EXTERN(autoplay_recording_suite);
...
int main(int argc, char **argv) {
    ...
    RUN_SUITE(unit_touch_regions_suite);
    ...
    RUN_SUITE(autoplay_recording_suite);
