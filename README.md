...
game (`build/debug/openbounty`) and the test runner (`build/openbounty-test`)
— plus a compile-only library boundary check that emits no binary.
...
- One save format: **JSON, version 7** (`SAVE_VERSION` in
