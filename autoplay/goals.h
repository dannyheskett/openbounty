...
typedef enum {
    ...
    STEP_FIRST_ENABLING,
    STEP_TAKE_CONTRACT = STEP_FIRST_ENABLING,  // GameTakeNextContract, cycle to V
    STEP_KIND_COUNT,
} PlanKind;
...
// `handle` is the STABLE ENTITY HANDLE:
...
// tile_bound = true (the generic tile-bound path fights
