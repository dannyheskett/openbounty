...
- **Engine:** Retro Diffusion rd_pro__default (128x128, seed 9987)
- **Pack path:** `art/portraits/troop_baleares.png`
- **prompt:** a head-and-shoulders portrait, the face filling the frame, of a Balearic slinger, a lean bare-chested islander with long dark hair tied back, a leather sling wound in his hand, a rocky island coast and the sea behind him
- **Note:** Static troop portrait (2026-09-13): 128 still with the troop's map sprite as reference, resized whole to 96 (Lanczos), keeping the background. No animation.
...
- **Engine:** Retro Diffusion user__glory_of_rome_troops_bac676cd (96x96, seed 6153)
- **prompt:** a Balearic slinger, bare-chested and wiry, a leather sling hanging loose from his right hand at his side, a pouch of stones at his hip, a cloth headband
...
- **Engine:** Retro Diffusion rd_advanced_animation__custom_action (96x96, seed 6154)
- **prompt:** he whirls the sling once in a circle above his head and releases the stone forward to the right, his arm following through in front of him, then the arm drops back to his side, both feet stay planted
