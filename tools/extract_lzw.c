// CC archive parser + LZW decoder. Ported from
// legacy/scripts/extract_raw.py.
//
...
// a known table (graphics bases × suffixes + a few specials) and
...
// Mirror of legacy/scripts/extract_raw.py:88-105. Building the hash
// table on every run is cheap (~80 entries × 3 suffixes + 9 specials).
