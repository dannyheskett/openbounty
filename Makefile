...
TEST_SRC := $(filter-out src/main.c src/autoplay/core.c src/autoplay/flow.c src/autoplay/nav.c src/autoplay/macros.c src/autoplay/missions.c,$(SHELL_SRC)) $(TOOL_SRC) $(TEST_ONLY_SRC)
