...
TEST_SRC := $(filter-out src/main.c src/autoplay/core.c src/autoplay/murray.c src/autoplay/grind_p0.c src/autoplay/hack.c src/autoplay/grind_p1.c,$(SHELL_SRC)) $(TOOL_SRC) $(TEST_ONLY_SRC)
